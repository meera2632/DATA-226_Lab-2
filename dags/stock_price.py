...
with DAG(
    dag_id='Lab_2_DAG',                               # Unique identifier for the DAG
    ...
    def fetch_stock_data():
        ...
        api_key = Variable.get("ALPHA_VANTAGE_API_KEY")  # Retrieving API key from Airflow Variable
        ...
        if "AAPL" not in unique_symbols or "TSLA" not in unique_symbols:
